  ...
  return (
    <section className="bg-black px-6 lg:px-16 flex flex-col lg:flex-row items-center justify-between gap-6 pt-16 md:pt-24 lg:pt-32 pb-8">
      ...
      <div className="flex-1 flex flex-col justify-between bg-white text-black px-8 w-full h-[492px] md:h-[928px] lg:max-h-[900px] lg:max-w[958]">
        ...
        <div className="text-[22px] lg:w-[728px] lg:h-[199px] leading-relaxed mb-10 mt-20 md:mt-0">
          <p
          ...
          <div className="pl-2 sm:pl-4 md:pl-8 lg:pl-10 lg:pt-10">
            <Link href="/careers">
              <button className="bg-black text-[14px] sm:text-[16px] md:text-[18px] lg:text-[22px] text-white px-4 sm:px-6 md:px-10 lg:px-12 py-2 sm:py-3 pl-2 sm:pl-4 md:pl-8 lg:pl-12 hover:scale-105 transition-transform duration-300  font-medium mt-4  max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg">
                Join the Team
              </button>
            </Link>
          </div>
      ...
      <div className="flex-1 w-full relative overflow-hidden h-[492px] md:h-[928px] lg:max-h-[900px] min-h-[340px] xs:min-h-[340px]">
        {/* Address Overlay */}
