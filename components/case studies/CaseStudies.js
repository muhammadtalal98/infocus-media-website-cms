      ...
      <div className="container mx-auto px-6">
        ...
        {data.length > visibleItems && 
          ...
          <button
            ...
            className="bg-black text-white px-6 py-3 cursor-pointer hover:bg-gray-500 hover:text-black hover:scale-105 transition-transform duration-300 rounded-md font-medium"
          >
