      ...
      <div className=" flex flex-col justify-between bg-black text-white px-4 w-full sm:h-[60vh] md:h-[50vh] lg:h-[80vh] lg:w-1/2">
        ...
        <div className="text-[22px] lg:w-[728] leading-relaxed mb-10 mt-20 md:mt-0">
          ...
          <div className="pl-2 sm:pl-4 md:pl-8 lg:pl-10 mt-5 lg:mt-10">
            <Link href="/careers">
              <button className="bg-white text-black rounded-md text-[14px] sm:text-[16px] md:text-[18px] lg:text-[22px] px-4 sm:px-6 md:px-10 lg:px-12 py-2 sm:py-3 pl-2 sm:pl-4 md:pl-8 lg:pl-12 hover:scale-105 transition-transform duration-300  font-medium mt-4  max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg">
                Join the Team
              </button>
            </Link>
          </div>
