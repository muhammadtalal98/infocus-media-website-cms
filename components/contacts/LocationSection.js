...
const LocationSection = () => {
  return (
    <div className="w-full h-[100vh] relative overflow-hidden">
      {/* Address Box */}
      <div className="absolute top-[60px] left-[60px] bg-white shadow-lg rounded-lg p-4 sm:p-6 lg:p-9 z-10 w-[90%] sm:w-[400px] lg:w-[568px] md-w-[424] sm:w-[342] flex flex-col gap-4">
