...
const LocationSection = () => {
  return (
    <div className="w-full h-[100vh] relative overflow-hidden">
      {/* Address Box */}
      <div className="relative lg:top-[60px] lg:left-[60px] sm:left-[24px] sm:top-[24px] bg-white shadow-lg rounded-lg p-4 sm:p-6 lg:p-9 z-10 w-[90%] sm:w-[310px] lg:w-[568px] md-w-[424] sm:w-[342] flex flex-col gap-4">
